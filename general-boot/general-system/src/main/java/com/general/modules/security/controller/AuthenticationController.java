package com.general.modules.security.controller;
...
import com.general.modules.security.security.AuthorizationUser;
import com.general.modules.security.security.ImgResult;
import com.general.modules.security.utils.JwtTokenUtil;
import com.general.modules.security.utils.VerifyCodeUtils;
...
public class AuthenticationController {
    ...
    public ResponseEntity login(@Validated @RequestBody AuthorizationUser authorizationUser){
        ...
        if(jwtUser.getUserType()==0) {
        	throw new AccountExpiredException("普通用户暂时无法登录当前系统");
        }
